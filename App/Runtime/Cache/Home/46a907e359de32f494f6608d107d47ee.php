...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/school/Public/Home/dist/build/css/build.css" />
	<style>
		.am-btn {
...
<body>
		...
		<div data-am-widget="tabs" class="am-tabs am-tabs-d2">
			<ul class="am-tabs-nav am-cf">
				<li class="am-active a-font">
					<a href="[data-tab-panel-0]">课程菜单</a>
				</li>
				<li class="a-font">
					<a href="[data-tab-panel-1]">师资介绍</a>
				</li>
			</ul>
			<div class="am-tabs-bd">
				<div data-tab-panel-0 class="am-tab-panel am-active">
					<div class="container index-container">
						<div class="row">
							...
							<?php if(is_array($exam)): $i = 0; $__LIST__ = $exam;if( count($__LIST__)==0 ) : echo "没有数据" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><div class="col-xs-4">
									<a href="/school/index.php/Home/Exam/exam/exam_id/<?php echo ($vol["exam_id"]); ?>/type/3">
				...
				<div data-tab-panel-1 class="am-tab-panel ">
					<div class="container index-container">
						<div class="row">
							<?php if(is_array($teacher)): $i = 0; $__LIST__ = $teacher;if( count($__LIST__)==0 ) : echo "没有老师信息" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><a href="/school/index.php/Home/teacher/show/teacher_id/<?php echo ($vol["teacher_id"]); ?>">
									<div class="col-xs-4">
										<img src="/school/<?php echo ($vol["teacher_head"]); ?>" />
										<div class="information-all">
											<span class="build-teacherName information"><?php echo ($vol["teacher_name"]); ?></span>
											<span class="build-process information"><?php echo ($vol["teacher_major"]); ?></span>
										</div>
									</div>
								</a><?php endforeach; endif; else: echo "没有老师信息" ;endif; ?>
	...
	<script src="/school/Public/Home/dist/build/js/build.js" type="text/javascript" charset="utf-8"></script>
</body>
