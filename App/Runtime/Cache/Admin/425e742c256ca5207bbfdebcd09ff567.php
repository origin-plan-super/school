    ...
    <script>
        ...
        */
        ...
        $('#add').on('click', function () {
            ...
            layer.prompt({
                formType: 2,
                title: '添加<?php echo ($school["school_title"]); ?>科目，换行可添加多个，<?php echo ($school["school_title"]); ?>科目不能重名。',
                    ...
                    for (var j = 0; j < arr.length; j++) {
                        ...
                        if (j != i) {
                            if (item_i['exam_title'] == item_j['exam_title']) {
                                //检测到重名
                                layer.msg('<?php echo ($school["school_title"]); ?>科目名：【' + item_i['exam_title'] + '】检测到冲突，请修改后再操作！');
                                layer.close(load);
                                return;
                            }
                        }
                            ...
                            for (var i = 0; i < arr.length; i++) {
                                ...
                                for (var j = 0; j < exam_arr.length; j++) {
                                    ...
                                    if (item_i['exam_title'] == item_j['exam_title']) {
                                        ...
                                        w(item_i['exam_title']);
                                        w(item_j['exam_title']);
                                        layer.msg('<?php echo ($school["school_title"]); ?>科目名：【' + item_i['exam_title'] + '】已存在，请修改后再操作！');
                                        layer.close(load);
                                        return;
                                    }
                                }
