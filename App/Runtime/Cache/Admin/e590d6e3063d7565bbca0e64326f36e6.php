        ...
        <div class="o-panel-body">
            ...
            <form class="layui-form">
                ...
                <div class="form-group" id="is_head">
                    ...
                    <br>
                    <img src="/school/<?php echo ($paper["paper_head"]); ?>" alt="" id="paper_head_img">
                ...
                <div class="form-group " id="is_video">
                    ...
                    <br>
                    <video id="video_box" src="/school/<?php echo ($paper["video"]); ?>" controls loop style='max-width:400px;display: block;margin: 0 auto'>
                    </video>
            ...
            var uploadInst = upload.render({
                ...
                , done: function (res) {
                    ...
                    if (res.code == 0) {
                        ...
                        $('#video_box').attr('src', '/school/' + res.data.src);
