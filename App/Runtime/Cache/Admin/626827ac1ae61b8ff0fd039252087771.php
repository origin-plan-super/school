...
<body>
            ...
            <div class="o-panel-body">
                ...
                <form class="layui-form">
                    <div class="form-group">
                        ...
                        <input type="text" class="o-form-control" lay-verify='required' value="虹桥镇社区学校" id="app_name" autocomplete="off" name="app_name"
                            placeholder="项目名">
                    </div>
                    <div class="text-right">
    ...
    <script src="/school/Public/Admin/dist/ctos/ctos.js"></script>
    <script>
        ...
        layui.use('form', function () {
            ...
            form.on('submit(userConfig)', function (data) {
                ...
                (function () {
                    ...
                    var url = '/school/index.php/Admin/Ctos/userConfig';
            ...
            form.on('submit(appConfig)', function (data) {
                ...
                (function () {
                    ...
                    var url = '/school/index.php/Admin/Ctos/appConfig';
                    var obj = {
                        save: {
