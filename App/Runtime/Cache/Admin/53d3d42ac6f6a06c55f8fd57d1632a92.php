...
<body>
    ...
    <div class="layui-row layui-form">
        <div class="layui-col-md12">
            ...
            <div class="layui-btn-group">
                <button class="layui-btn layui-btn-sm layui-black " data-tips='3' data-color='#666' title='新增老师' id="add">
            ...
            <div class="layui-btn-group">
                ...
                <a class="layui-btn layui-btn-sm layui-black" href='<?php echo U("home/build/build");?>' target="_blank" lay-event="branch-teacher"
                    data-tips='3' title='查看老师列表'>
                    老师列表
                </a>
    ...
    <script type="text/html" id="barTool">
        ...
        <a  class="layui-btn layui-btn-xs layui-black" lay-event="branch-teacher" data-tips='4' title='管理老师信息'>
            <i class="layui-icon">&#xe614;</i>
        </a>
        <a  class="layui-btn layui-btn-xs layui-black" lay-event="show-teacher" data-tips='1' title='查看老师信息'>
                <i class="layui-icon">&#xe614;</i>
        </a>
    ...
    <script type="text/html" id="checkboxTpl">
        <input type="checkbox" name="lock" value="{{d.teacher_id}}" title="推荐" lay-filter="is_up" {{ d.is_up == 1 ? 'checked' : '' }}>
    </script>
    ...
    <script>
        ...
        layui.use(['table', 'form'], function () {
            ...
            tableIns = table.render({
                ...
                , where: {
                    table: 'teacher',
                    order: 'teacher_name asc,add_time desc',
                    where: {
                ...
                , cols: [[ //表头s
                    ...
                    , { field: 'teacher_id', title: 'id', width: 100 }
                    , { field: 'teacher_name', title: '老师名', width: 200, edit: 'text' }
            ...
            table.on('tool(table_filter)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'branch-teacher') {
                    //编辑老师
                    window.open('/school/index.php/Admin/Teacher/show/teacher_id/' + data.teacher_id);
                    return;
                    layer.open({
                        type: 2,
                        title: '【' + data.teacher_name + '】的信息',
                        shadeClose: true,
                        shade: 0.3,
                        area: ['80%', '100%'],
                        content: '/school/index.php/Admin/Teacher/show/teacher_id/' + data.teacher_id,
                        end: function () {
                            tableIns.reload();
                        }
                    });
                ...
                if (layEvent === 'show-teacher') {
                    //编辑老师
                    window.open('/school/index.php/home/teacher/show/teacher_id/' + data.teacher_id);
            ...
            */
            table.on('edit(table_filter)', function (obj) { //注：edit是固定事件名，test是table原始容器的属性 lay-filter="对应的值"
                console.log(obj.value); //得到修改后的: '<?php echo ($exam_id); ?>'
                console.log(obj.field); //当前编辑的字段名
                console.log(obj.data); //所在行的所有相关数据  

                var save = {
                    table: 'teacher',
                    id: obj.data.teacher_id,
                    save: {}
                };
        ...
        */
        $(document).on('click', '#reload', function () {
            ...
            var key = $('#key').val();
            var key_where = 'teacher_id|teacher_name';
            //执行重载
            tableIns.reload({
                page: {
                    curr: 1 //重新从第 1 页s开始
        ...
        $('#add').on('click', function () {
            ...
            layer.prompt({
                ...
                var arr = strToArr(value, '\n', function (i, arr, element) {
                    ...
                    var item = {};
                    item.teacher_name = element;
                    item.school_id = 1;
                    item.exam_id = '<?php echo ($exam_id); ?>';
                    return item;
