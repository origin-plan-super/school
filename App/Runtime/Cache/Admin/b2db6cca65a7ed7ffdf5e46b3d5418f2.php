...
<head>
    ...
    <title>【<?php echo ($pages["pages_title"]); ?>】的页面设计</title>
    <!-- css -->
...
<script>
    ...
    <link href="/school/Public/Admin/dist/pages/studio.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <div class="page-header">
        <h1>
            <small>【<?php echo ($pages["pages_title"]); ?>】的页面设计</small>
        </h1>
    </div>
    <ol class="breadcrumb">
        <li>
            <a href="/school/index.php/Admin/Index/index">图文详情管理</a>
        </li>
        <li>
            <a href="/school/index.php/Admin/Index/index">页面管理</a>
        </li>
        <li class="active">【<?php echo ($pages["pages_title"]); ?>】的页面设计</li>
    </ol>
    ...
    <script src="/school/Public/Admin/dist/pages/studio.js"></script>
    <script>
        ...
        var el = {
            ...
            leftImg: function () {
                ...
                $div.append('<img class="left-img" src="/school/Public/assets/img/1.jpg" alt="">');
            ...
            topImg: function () {
                ...
                $div.append('<img class="top-img" src="/school/Public/assets/img/1.jpg" alt="">');
