...
<script>
    ...
    <link rel="stylesheet" type="text/css" href="/school/Public/vendor/umeditor/themes/default/css/umeditor.css" />
    <title>发布文章</title>
    <style>
        body {
            padding: 0 100px;
...
<body>
        ...
        <div class="o-panel-body">
            ...
            <form class="layui-form">
                <div class="form-group">
                    <label>文章标题</label>
                    <input type="text" value="<?php echo ($paper["paper_title"]); ?>" autocomplete="off" class="o-form-control" name="paper_title" placeholder="文章标题">
                </div>
                <div class="form-group" id="is_head">
                    ...
                    <br>
                    <img src="/school/<?php echo ($paper["paper_head"]); ?>" alt="" id="paper_head_img" name="paper_head">
                    <input type="hidden" name="paper_head" value='<?php echo ($paper["paper_head"]); ?>' id="paper_head">
                </div>
                <div class="form-group " id='is_video' style="display: none">
                    <label>视频</label>
                    ...
                    <br>
                    <video id="video_box" controls loop style='max-width:400px;display: block;margin: 0 auto'>
                        <source src="">
                        <!-- /school//Public/Upload//paper/video/2017-12-14/5a3221aa0f9b8.mp4 -->
                    </video>

                    <input type="hidden" name="video" value='<?php echo ($paper["video"]); ?>' id="video">
                </div>
                <div class="form-group">
                    <label>发布到页面</label>
                ...
                <div class="form-group" id="is_content">
                    ...
                    <script id="container" name="content" type="text/plain" style="width:100%" lay-verify='required'><?php echo (htmlspecialchars_decode($paper["content"])); ?></script>
    ...
    <!-- 引入 etpl -->
    <script src="/school/Public/vendor/umeditor/third-party/template.min.js" type="text/javascript" charset="utf-8"></script>
    <!-- 配置文件 -->
    <script src="/school/Public/vendor/umeditor/umeditor.config.js" type="text/javascript" charset="utf-8"></script>
    <!-- 编辑器源码文件 -->
    <script src="/school/Public/vendor/umeditor/umeditor.js" type="text/javascript" charset="utf-8"></script>
    <!-- 语言包文件 -->
    <script src="/school/Public/vendor/umeditor/lang/zh-cn/zh-cn.js" type="text/javascript" charset="utf-8"></script>
        ...
        layui.use(['form', 'upload'], function () {
            ...
            form.on('submit(save)', function (data) {
                ...
                (function () {
                    ...
                    var url = '/school/index.php/Admin/use/add';
                    var obj = {
                        table: 'paper',
                        add: data.field
                    };
            ...
            var uploadInst = upload.render({
                ...
                , data: {
                    src: '/paper/img/',
                    del_src: '<?php echo ($paper["paper_head"]); ?>'
                }
                , drag: true
                , done: function (res) {
                    //上传完毕回调4
                    ...
                    if (res.code == 0) {
                        //成功
                        $('#paper_head_img').attr('src', '/school/' + res.data.src);
            ...
            var uploadInst = upload.render({
                ...
                , done: function (res) {
                    ...
                    if (res.code == 0) {
                        ...
                        $('#video_box').empty();
                        var $source = $('<source/>')
                        $source.attr('src', '/school/' + res.data.src);
                        $('#video_box').append($source);
            ...
            linkage(arr, form, ['<?php echo ($paper["pages_title"]); ?>', '<?php echo ($paper["class_title"]); ?>']);
