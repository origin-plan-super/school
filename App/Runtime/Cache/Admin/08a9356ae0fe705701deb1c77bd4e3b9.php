...
<body>
    ...
    <script type="text/html" id="bar1">
        <a class="layui-btn layui-btn-xs layui-black tips" title='修改密码' data-tips='4' data-color='#666'lay-event="edit">
                <!-- 修改密码 -->
            <i class="layui-icon">&#xe642;</i> 
        </a>
        <button class="layui-btn layui-btn-xs layui-btn-danger tips" lay-event="del" title='删除'data-tips='4' data-color='rgb(253, 51, 51)'>
            <i class="layui-icon">&#xe640;</i>
        </button>
    ...
    <script>
        ...
        layui.use(['table', 'form'], function () {
            ...
            tableIns = table.render({
                ...
                , elem: '#table'
                , even: true //开启隔行背景
                , url: '/school/index.php/Admin/Config/getList' //数据接口
                , where: {
                    table: 'admin',
                    ...
                    layer.prompt({
                        ...
                        layer.prompt({
                            ...
                            (function () {
                                ...
                                var url = '/school/index.php/Admin/Config/edit';
                                var obj = {
                ...
                layer.prompt({
                    ...
                    layer.prompt({
                        ...
                        (function () {
                            ...
                            var url = '/school/index.php/Admin/Config/add';
                            var obj = {
