...
<head>
    ...
    <title>【<?php echo ($exam["exam_title"]); ?>】的课程管理</title>
    <!-- css -->
...
<body>
    ...
    <div class="page-header">
        <h1>
            <small>【<?php echo ($exam["exam_title"]); ?>】的课程管理</small>
        </h1>
    </div>
    ...
    <ol class="breadcrumb">
        ...
        <li>
            <a href='/school/index.php/Admin/school/showList/school_id/<?php echo ($school["school_id"]); ?>'><?php echo ($school["school_title"]); ?></a>
        </li>
    ...
    <div class="layui-row layui-form">
        <div class="layui-col-md12">
            ...
            <div class="layui-btn-group">
                <button class="layui-btn layui-btn-sm layui-black " data-tips='3' data-color='#666' title='新增课程' id="add">
    ...
    <script>
        ...
        layui.use(['table', 'form'], function () {
            ...
            tableIns = table.render({
                ...
                , where: {
                    table: 'subject',
                    order: 'subject_title asc,add_time desc',
                    where: {
            ...
            table.on('tool(table_filter)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'branch-subject') {
                    //编辑课程
                    // window.open('/school/index.php/Admin/Exam/show/subject_id/' + data.subject_id);
                    layer.open({
                        type: 2,
                        ...
                        shade: 0.3,
                        area: ['80%', '100%'],
                        content: '/school/index.php/Admin/Exam/show/subject_id/' + data.subject_id,
                        end: function () {
                            tableIns.reload();
                        }
                    });
