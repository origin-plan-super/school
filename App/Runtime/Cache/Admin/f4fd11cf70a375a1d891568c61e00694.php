...
<body>
    ...
    <div class="o-body-pt">
        ...
        <div class="head-img-box">
            <img src="/school<?php echo (session('admin_head_img')); ?>" class="admin-head-img" id="admin-head-img" alt="">
        ...
        layui.use(['form', 'upload'], function () {
            ...
            form.on('submit(admin_pwd)', function (data) {
                ...
                (function () {
                    ...
                    var url = '/school/index.php/Admin/Config/userConfig';
                    var obj = data.field;
                    var fun = function (res) {
                        w(res);
                        try {
            ...
            form.on('submit(admin_name)', function (data) {
                ...
                (function () {
                    ...
                    var url = '/school/index.php/Admin/Config/saveName';
                    var obj = data.field;
                    var fun = function (res) {
                        w(res);
                        try {
                ...
                , done: function (res) {
                    ...
                    if (res.code == 0) {
                        ...
                        (function () {
                            ...
                            var url = '/school/index.php/Admin/Config/saveHeadImg';
                            var obj = {
