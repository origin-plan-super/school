...
<head>
    ...
    <style>
        ...
        .zz-img {
            ...
            width: 100vw;
            height: 100vh;
            background-image: url('/school/Public/assets/img/admin/5.jpg');
...
<body>
    ...
    <script src="/school/Public/vendor/Jquery/jquery.js"></script>
    ...
    <script>
        ...
        layui.use('form', function () {
            ...
            form.on('submit(login)', function (data) {
                ...
                $.post('/school/index.php/Admin/Login/login', data.field, function (res) {
                    res = JSON.parse(res);
        ...
        var code = function () {
            obj = {
                ...
                upCode: function () {
                    $(obj.config.el).attr('src', '/school/index.php/Admin/Login/getCode');
                }
            }
            return obj;
        }();
